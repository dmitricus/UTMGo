...
type EmailServers struct {
	...
	EmailSSLKeyfile   string    `json:"email_ssl_key_file" gorm:"filepat"`                                 // Файл ключа EmailServers/keyfile/%Y/%m/%d
	...
	MainServer        bool      `json:"main_server"`                                                       // Основной сервер
	IsActive          bool      `json:"is_active"`                                                         // Сервер активен
